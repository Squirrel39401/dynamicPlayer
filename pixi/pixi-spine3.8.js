 ...
 * Compiled Thu, 12 Jan 2023 05:25:26 UTC
 *
 ...
 */
this.PIXI = this.PIXI || {};
this.PIXI.spine_3 = this.PIXI.spine_3 || {};
    ...
    ***************************************************************************** */
    ...
    var SpineBase = /** @class */ (function (_super) {
        ...
        SpineBase.prototype.createMesh = function (slot, attachment) {
            ...
            if (isFinite(attachment.scaleX)) {
                strip.scale.x = attachment.scaleX
            }
            if (isFinite(attachment.scaleY)) {
                strip.scale.y = attachment.scaleY
            }

            if (isFinite(attachment.x)) {
                strip.x = attachment.x
            }
            if (isFinite(attachment.y)) {
                strip.y = attachment.y
            }
        ...
        SkeletonJson.prototype.readSkeletonData = function (json) {
            ...
            if (root.bones) {
                for (var i = 0; i < root.bones.length; i++) {
                    ...
                    var data = new BoneData(skeletonData.bones.length, boneMap.name, parent_2);
